...
public class F_Timesheet_Approval_Page2 extends CommonPageCICA {
	...
	public void Pending_Approvals4() throws Exception {
		sleep(1);
		clickElement(Pending_Approvals);
		sleep(0.5);
		setText(SearchBar, "C"); 
	...
	public void Pending_Approvals5() throws Exception {
		sleep(1);
		clickElement(Pending_Approvals);
