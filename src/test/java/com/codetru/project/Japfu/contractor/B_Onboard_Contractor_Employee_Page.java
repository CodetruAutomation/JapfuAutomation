...
public class B_Onboard_Contractor_Employee_Page extends CommonPageCICA{
	...
	private By Vendor_Type = By.xpath("//label[.='Vendor']/following-sibling::div/input[@role='combobox']");
	...
	private By Deposit_Configuration = By.xpath("//label[.='Choose Deposit Configuration']/following-sibling::div/input[@role='combobox']");
...
//		sleep(0.5);
		...
		clickElement(Deposit_Configuration);
